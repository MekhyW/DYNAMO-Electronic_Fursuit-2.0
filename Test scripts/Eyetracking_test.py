...
def calculate_eye_displacement(eye_points, iris_points):
    center, axes = fit_ellipse(iris_points)
...
def eye_track(frame):
    ...
    if results_mesh.multi_face_landmarks:
        ...
        displacement_left_eye = calculate_eye_displacement(mesh_points[LEFT_EYE], mesh_points[LEFT_IRIS])
        displacement_right_eye = calculate_eye_displacement(mesh_points[RIGHT_EYE], mesh_points[RIGHT_IRIS])
        ...
        cv2.ellipse(frame, (int(ellipse_center_L[0]), int(ellipse_center_L[1])), (int(ellipse_axes_L[0]/2), int(ellipse_axes_L[1]/2)), 0, 0, 360, (0, 255, 0), 2)
        cv2.ellipse(frame, (int(ellipse_center_R[0]), int(ellipse_center_R[1])), (int(ellipse_axes_R[0]/2), int(ellipse_axes_R[1]/2)), 0, 0, 360, (0, 255, 0), 2)
