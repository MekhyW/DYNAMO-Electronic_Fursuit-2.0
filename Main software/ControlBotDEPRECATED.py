...
main_menu_buttons = ['🎵 Music / Sound', '🎙️ Voice', '😁 Expression', '👀 Eye Tracking', '📺 Displays', '⚙️ Animatronic', '💡 LEDs', '🍪 Cookiebot (Assistant AI)', '🖼️ Refsheet / Sticker Pack', '🔧 Debugging', '🛑 Shutdown']
...
inline_keyboard_debugging = [[{'text': 'Remote Desktop', 'callback_data': 'debugging anydesk'}], [{'text': 'Resources', 'callback_data': 'debugging resources'}], [{'text': 'Set audio input', 'callback_data': 'audiodevice input'}, {'text': 'Set audio output', 'callback_data': 'audiodevice output'}], [{'text': 'Close Menu', 'callback_data': 'close'}]]
...
def thread_function(msg):
    try:
        ...
        if content_type == 'text':
            if chat_id in last_message_chat and 'data' in last_message_chat[chat_id] and last_message_chat[chat_id]['data'] == 'tts':
